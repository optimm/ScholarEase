  ...
  const {
    ...
    onSubmit: async (values) => {
      try {
        ...
        resetForm();
        createNotification(
          `Welcome${data?.data?.isadmin ? " Admin," : ","} ${data?.data?.name}`,
          "success",
          2000
        );
        ...
        <MainCard>
          ...
          <MainCardImage url="/images/login.jpg">
            <MainCardOverLay>
              ...
              <div className="text">
                Login and you can view multiple scholarships, comment and save
                them. You can also add scholarships to help others and let the
                world appreciate.
              </div>
